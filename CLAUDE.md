# CLAUDE.md — `concurrent_roaring`: Static Technical Plan
...
> This file lives at the repo root so Claude Code auto-loads it into every session.
...
**Preconditions:** empty directory, `git init` done, `CLAUDE.md` + `commit.md` present at root.
